...
<table>
  <tr>
    <td><img width="430" height="570" alt="image" src="https://github.com/user-attachments/assets/c1cd0770-ae2a-4df3-8f76-679c9da0858b" /></td>
    <td><img width="430" height="570" alt="image" src="https://github.com/user-attachments/assets/2f6f2b6e-4e0a-4096-ba81-1334f13d678a" /></td>
  </tr>
</table>
...
```text
AIKONG2024/wow-pdf-translate-skill 스킬 설정해줘
```
...
이 저장소를 읽고 현재 에이전트 런타임이 사용하는 skill 디렉터리에 `wow-pdf-translate-skill` 스킬을 설치하세요.
...
- GitHub skill 설치를 지원하면 `AIKONG2024/wow-pdf-translate-skill` 저장소의 `wow-pdf-translate-skill` 경로를 설치하세요.
...
- 수동 local skill만 지원하면 `wow-pdf-translate-skill/` 폴더를 해당 런타임의 skill 디렉터리에 복사하세요.
